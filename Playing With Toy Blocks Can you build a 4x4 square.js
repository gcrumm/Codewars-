...
function buildSquare(blocks) {
  ...
  let count4 = blocks.filter(b => b === 4).length;
  let count3 = blocks.filter(b => b === 3).length;
  let count2 = blocks.filter(b => b === 2).length;
  let count1 = blocks.filter(b => b === 1).length;
